...
<!-- --------------------------------------------------- -->
	...
	<a href="rendering_of_service/index.htm" tppabs="http://www.vagr.vitebsk.by/rendering_of_service/" title="Предварительная запись" id="hml221" onMouseOver="hMenuShow(221);" onMouseOut="hMenuHide(221);"  onclick="return false;">Предварительная запись</a>
</li>
<!-- --------------------------------------------------- -->
