...
<body onkeydown="if(event.ctrlKey && event.keyCode == 83 && event.shiftKey) window.location='admin/ind.php';">
  ...
  <tr valign="top" align="center" width="100%" >
    ...
    <H2 align="center"><marquee direction="left" scrollAmount="3" width="931">Внимание! Новый вид деятельности. Агентство оказывает услуги по <b>проведению независимой оценки для приватизации жилых помещений по Указу Президента Республики Беларусь от 25.01.2016г. №25 (тел. +375 (0212) 60 91 24), выполняет работы по топографической и исполнительной съемке по Витебской области, короткие сроки, рассрочка платежа. Телефоны в Витебске 8 (0212) 60 81 74, в Полоцке 8 (0214) 42 12 46, в Орше 8 (0216) 51 18 81, в Глубоком 8 (0215) 62 34 41</marquee></H2>
	</td>
   </tr>
   <tr>
