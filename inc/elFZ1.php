...
//----------------------------------------------------------------------------------------------------------------------------------
  ...
  // $to - кому отправляем 
   ...
   // функция, которая отправляет наше письмо. 
    ...
    if ($_POST['CountryFiz']==200) {$mail_to = 'a200@nca.by'; }
   ...
   if (preg_match("/[<>\/]/", $fioman))
   {
	...
	{	  
      ...
      /* $file=$_POST['nameFile'];
	   ...
	   // вложение в письмо (файл)
	   //$message.='------------A4D921C2D10D7DB'."\r\n";
	   
	   /*$message.="Content-Type: application/octet-stream"."\r\n";  //.$_POST['nameFile']."\""."\r\n";
       $message.="Content-Transfer-Encoding: base64"."\r\n";
       //$message.="Content-Disposition: attachment; filename=\"".$_POST['nameFile']."\""."\r\n\r\n".$code_file1."\r\n\r\n";
	   $message.="Content-Disposition: attachment; filename=\"".$_POST['nameFile']."\"\r\n\r\n";
	   $message.=chunk_split(base64_encode($content))."\r\n"; */
	   $message.=$file;
	  // $message.="Content-Disposition: attachment; filename=\"$value\"\r\n\r\n";
