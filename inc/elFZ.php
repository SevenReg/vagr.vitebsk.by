...
//   	if ($_POST['CountryFiz']==200) {$mail_to = 'booom200585@mail.ru'; }
   ...
   if (preg_match("/[<>\/]/", $fioman))
   {
	...
	{	  
	   ...
	   $subject='Электронное обращение граждан';
       ...
       $message.='Вопрос:'.$_POST['question'].' Кому:'.$_POST['fioman'].' Фамилия Имя Отчество:'.$_POST['fio'].', e-mail: '.$_POST['email'].', Адрес: '.$_POST['tel']."\r\n\r\n";
	   //Текст письма
	   $message.=$file;
   	   $message.="------------A4D921C2D10D7DB--"."\r\n";
